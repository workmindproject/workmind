...
import EmailForm from '@/components/signin/email.form.vue';
import PasswordForm from '@/components/signin/password.form.vue';
...
const data = ref({ step: SIGNIN_STATE['email'], email: '', password: '', rememberMe: false })
