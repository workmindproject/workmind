...
export default component$<EmailSignupFormProps>((props: EmailSignupFormProps) => {
    // useStylesScoped$(styles);
    const store = useStore({ email: props.value, })
    return (
        <form class="grid grid-cols-1 mt-8 md:grid-cols-1">
            {/* <!-- Email input --> */}
            <div class="mb-6">
